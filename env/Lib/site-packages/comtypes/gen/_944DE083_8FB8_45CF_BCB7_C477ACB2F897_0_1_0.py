...
__all__ = [
    'UIA_TextControlTypeId', 'UIA_SpreadsheetItemPatternId',
    'StyleId_Custom', 'StyleId_Heading8', 'IUIAutomationTextRange3',
    'IUIAutomationWindowPattern',
    'UIA_MultipleViewCurrentViewPropertyId',
    'IUIAutomationNotCondition', 'AnnotationType_Mathematics',
    'AnnotationType_Endnote', 'DockPosition_Right',
    'AnnotationType_CircularReferenceError', 'AnnotationType_Author',
    'UIA_SpreadsheetPatternId', 'UIA_SayAsInterpretAsMetadataId',
    'UIA_AccessKeyPropertyId', 'UIA_TextChildPatternId',
    'RowOrColumnMajor', 'IUIAutomationTextEditPattern',
    'UIA_IsSynchronizedInputPatternAvailablePropertyId',
    'AnnotationType_FormulaError', 'DockPosition_Left',
    'ZoomUnit_NoAmount', 'WindowInteractionState_Closing',
    'TextEditChangeType_Composition', 'RowOrColumnMajor_ColumnMajor',
    'UIA_SpreadsheetItemFormulaPropertyId', 'LiveSetting',
    'StructureChangeType_ChildrenInvalidated',
    'ProviderOptions_ServerSideProvider',
    'UIA_HasKeyboardFocusPropertyId',
    'NotificationProcessing_ImportantAll', 'UIA_RangeValuePatternId',
    'CoalesceEventsOptions_Enabled', 'IUIAutomationElementArray',
    'UIA_CaretBidiModeAttributeId', 'UIA_TransformCanMovePropertyId',
    'ConnectionRecoveryBehaviorOptions_Enabled',
    'AnnotationType_UnsyncedChange', 'UIA_OutlineColorPropertyId',
    'IUIAutomationProxyFactory', 'UIA_ProgressBarControlTypeId',
    'IUIAutomationDragPattern', 'HeadingLevel_None',
    'UIA_InputReachedTargetEventId',
    'UIA_LegacyIAccessibleKeyboardShortcutPropertyId',
    'NotificationKind', 'UIA_StrikethroughColorAttributeId',
    ...
    'IUIAutomationChangesEventHandler', 'IUIAutomationCacheRequest',
    'UIA_WindowControlTypeId', 'UIA_ClickablePointPropertyId',
    'UIA_TextEdit_TextChangedEventId',
    'StructureChangeType_ChildrenReordered', 'CoalesceEventsOptions',
    'UIA_SelectionSelectionPropertyId',
    'UIA_AnnotationObjectsAttributeId', 'UIA_AriaRolePropertyId',
    'UIA_AnnotationAnnotationTypeNamePropertyId',
    'UIA_MarginLeadingAttributeId', 'IUIAutomationElement9',
    'SynchronizedInputType_RightMouseDown',
    'UIA_ItemStatusPropertyId', 'ZoomUnit_SmallDecrement',
    'UIA_IsObjectModelPatternAvailablePropertyId',
    'UIA_TextEdit_ConversionTargetChangedEventId',
    'IUIAutomationGridItemPattern', 'IUIAutomationSelectionPattern',
    'UIA_MenuControlTypeId', 'OrientationType_Vertical',
    'WindowVisualState', 'DockPosition_Fill',
    'NavigateDirection_PreviousSibling',
    'UIA_DropTarget_DragLeaveEventId', 'AnnotationType_Sensitive',
    'UIA_CultureAttributeId', 'TreeScope_Children',
    'UIA_GroupControlTypeId', 'TreeTraversalOptions_PostOrder',
    'UIA_DropTargetDropTargetEffectPropertyId', 'TextUnit_Word',
    'UIA_AnnotationTypesPropertyId', 'UIA_ItemContainerPatternId',
    'NotificationKind_ItemRemoved', 'IUIAutomationEventHandlerGroup',
    'RowOrColumnMajor_RowMajor',
    'UIA_LegacyIAccessibleStatePropertyId', 'StructureChangeType',
    'RowOrColumnMajor_Indeterminate',
    'UIA_ExpandCollapseExpandCollapseStatePropertyId',
    'IUIAutomationPropertyChangedEventHandler',
    'UIA_FontNameAttributeId', 'UIA_UnderlineStyleAttributeId',
    'UIA_TableRowHeadersPropertyId', 'UIA_ToolTipClosedEventId',
    'StyleId_Heading7', 'IUIAutomationTreeWalker', 'StyleId_Emphasis',
    'OrientationType_Horizontal',
    'UIA_StylesFillPatternColorPropertyId',
    'UIA_TransformCanResizePropertyId',
    'ConnectionRecoveryBehaviorOptions',
    'UIA_ScrollHorizontalScrollPercentPropertyId',
    'UIA_SizePropertyId', 'UIA_Selection_InvalidatedEventId',
    'UIA_ValuePatternId',
    'UIA_IsMultipleViewPatternAvailablePropertyId',
    'UIA_BulletStyleAttributeId', 'UIA_TreeControlTypeId',
    'UIA_ButtonControlTypeId', 'UIA_InputDiscardedEventId',
    'UIA_LegacyIAccessibleDescriptionPropertyId',
    'UIA_LayoutInvalidatedEventId', 'UIA_IsPasswordPropertyId',
    'IUIAutomation3', 'UIA_IsKeyboardFocusablePropertyId',
    'UIA_SelectionItemSelectionContainerPropertyId',
    'UIA_HorizontalTextAlignmentAttributeId',
    'IUIAutomationProxyFactoryMapping', 'UIA_MenuModeStartEventId',
    'StyleId_Heading3', 'UIA_MultipleViewSupportedViewsPropertyId',
    'SynchronizedInputType_KeyUp', 'UIA_ComboBoxControlTypeId',
    'UIA_HeaderControlTypeId', 'ProviderOptions_UseComThreading',
    'UIA_IsVirtualizedItemPatternAvailablePropertyId',
    'UIA_StylesPatternId', 'OrientationType_None',
    'NavigateDirection_NextSibling',
    'IUIAutomationSynchronizedInputPattern',
    'UIA_CustomLandmarkTypeId',
    'UIA_Text_TextSelectionChangedEventId',
    'NotificationProcessing_ImportantMostRecent',
    'DockPosition_Bottom', 'UIA_LocalizedLandmarkTypePropertyId',
    'UIA_IsTransformPattern2AvailablePropertyId', 'IUIAutomation5',
    'UIA_CustomNavigationPatternId',
    'UIA_RangeValueLargeChangePropertyId',
    'UIA_ControlTypePropertyId', 'UIA_DragDropEffectsPropertyId',
    'WindowVisualState_Normal', 'UIA_AcceleratorKeyPropertyId',
    'StyleId_Title', 'TreeTraversalOptions_Default',
    'UIA_RangeValueIsReadOnlyPropertyId',
    'UIA_AnnotationTargetPropertyId', 'IAccessible',
    'AnnotationType_ConflictingChange', 'UIA_TablePatternId',
    'TreeScope_Element', 'UIA_IsRangeValuePatternAvailablePropertyId',
    'NavigateDirection_FirstChild',
    'UIA_ScrollVerticalScrollPercentPropertyId',
    'UIA_OverlineStyleAttributeId', 'UIA_DragIsGrabbedPropertyId',
    'ToggleState', 'UIA_StyleIdAttributeId',
    'UIA_WindowIsModalPropertyId',
    'UIA_IsTextPatternAvailablePropertyId',
    'IUIAutomationTextPattern', 'UIA_NamePropertyId',
    'UIA_ScrollHorizontallyScrollablePropertyId', 'ToggleState_Off',
    ...
    'UIA_SizeOfSetPropertyId', 'UIA_Drag_DragStartEventId',
    'UIA_RangeValueMaximumPropertyId',
    'UIA_IndentationFirstLineAttributeId',
    'PropertyConditionFlags_IgnoreCase', 'UIA_FillColorPropertyId',
    'UIA_DockDockPositionPropertyId', 'UIA_LineSpacingAttributeId',
    'UIA_TitleBarControlTypeId',
    'UIA_SpreadsheetItemAnnotationTypesPropertyId',
    'IUIAutomationTransformPattern', 'UIA_FontSizeAttributeId',
    'UIA_GridItemRowPropertyId', 'IUIAutomationSpreadsheetPattern',
    'UIA_TabsAttributeId', 'UIA_TextFlowDirectionsAttributeId',
    'UIA_StylesStyleNamePropertyId',
    'IUIAutomationMultipleViewPattern', 'CUIAutomation8',
    'UIA_IsDataValidForFormPropertyId',
    'TextPatternRangeEndpoint_Start', 'UIA_SliderControlTypeId',
    'UIA_EditControlTypeId', 'UIA_WindowPatternId',
    'UIA_FrameworkIdPropertyId', 'UIA_DropTargetPatternId',
    'StyleId_Heading9', 'StyleId_NumberedList', 'HeadingLevel1',
    'IUIAutomationOrCondition',
    'ProviderOptions_HasNativeIAccessible', 'HeadingLevel8',
    'NotificationKind_ActionCompleted',
    'UIA_SelectionActiveEndAttributeId',
    'UIA_BoundingRectanglePropertyId', 'IUIAutomationTextPattern2',
    'TreeScope_Descendants', 'UIA_DragGrabbedItemsPropertyId',
    'ProviderOptions_UseClientCoordinates',
    'UIA_WindowWindowVisualStatePropertyId',
    'UIA_IsSubscriptAttributeId', 'DockPosition', 'HeadingLevel9',
    'IUIAutomationVirtualizedItemPattern', 'NavigateDirection_Parent',
    'UIA_MainLandmarkTypeId', 'IUIAutomationStylesPattern',
    'IUIAutomationSelectionItemPattern', 'TreeScope',
    'UIA_BeforeParagraphSpacingAttributeId',
    'UIA_IsDockPatternAvailablePropertyId',
    'IUIAutomationTableItemPattern',
    'UIA_IsTableItemPatternAvailablePropertyId', 'TextUnit_Page',
    ...
    'UIA_SayAsInterpretAsAttributeId', 'PropertyConditionFlags_None',
    'AnnotationType_Footnote', 'IUIAutomationTextRange',
    'UIA_DragDropEffectPropertyId', 'UIA_RangeValueValuePropertyId',
    'IUIAutomationTablePattern', 'UIA_AnnotationPatternId',
    'UIA_SelectionItem_ElementRemovedFromSelectionEventId',
    'UIA_DragPatternId', 'UIA_WindowIsTopmostPropertyId',
    'UIA_IsAnnotationPatternAvailablePropertyId',
    'UIA_MenuItemControlTypeId', 'DockPosition_None',
    'StructureChangeType_ChildrenBulkRemoved',
    'IUIAutomationItemContainerPattern', 'UIA_GridItemPatternId',
    'UIA_TableItemColumnHeaderItemsPropertyId',
    'SynchronizedInputType_LeftMouseDown', 'ExpandCollapseState',
    'UIA_IsRequiredForFormPropertyId', 'UIA_LiveSettingPropertyId',
    'UIA_LegacyIAccessibleSelectionPropertyId',
    'UIA_AnnotationAnnotationTypeIdPropertyId',
    'UIA_UnderlineColorAttributeId', 'UIA_ScrollBarControlTypeId',
    'UIA_OutlineStylesAttributeId', 'OrientationType',
    'UIA_StrikethroughStyleAttributeId', 'UIA_SelectionPattern2Id',
    'AutomationElementMode_Full', 'SupportedTextSelection_Multiple',
    'ScrollAmount', 'UIA_Transform2ZoomMinimumPropertyId',
    'UIA_GridItemColumnSpanPropertyId', 'UIA_ItemTypePropertyId',
    'UIA_LegacyIAccessibleDefaultActionPropertyId',
    'UIA_CalendarControlTypeId', 'StyleId_Heading6',
    'WindowVisualState_Minimized', 'TreeScope_Ancestors',
    'ZoomUnit_LargeIncrement', 'UIA_StatusBarControlTypeId',
    'TreeScope_None', 'AnnotationType_MoveChange',
    'UIA_IsSpreadsheetItemPatternAvailablePropertyId', 'Polite',
    'UIA_StyleNameAttributeId', 'UIA_Invoke_InvokedEventId',
    'UIA_SelectionItemIsSelectedPropertyId',
    'UIA_StylesFillPatternStylePropertyId',
    'UIA_WindowWindowInteractionStatePropertyId',
    'IUIAutomationSpreadsheetItemPattern',
    'UIA_IsExpandCollapsePatternAvailablePropertyId',
    'ScrollAmount_LargeDecrement', 'AnnotationType_SpellingError',
    'IUIAutomationAndCondition',
    'UIA_IsValuePatternAvailablePropertyId',
    'UIA_SemanticZoomControlTypeId', 'UIA_TextEditPatternId',
    'UIA_IsSelectionItemPatternAvailablePropertyId',
    'AnnotationType_Footer', 'UIA_IsHiddenAttributeId',
    'UIA_ScrollHorizontalViewSizePropertyId', 'UIA_TextPatternId',
    'IUIAutomationElement3', 'AnnotationType_ExternalChange',
    'UIA_IsInvokePatternAvailablePropertyId',
    'UIA_IsActiveAttributeId', 'UIA_MarginTopAttributeId',
    'UIA_DockPatternId', 'NotificationProcessing_All',
    'WindowInteractionState', 'IUIAutomationElement',
    'TreeTraversalOptions', 'AnnotationType_EditingLockedChange',
    'UIA_AutomationIdPropertyId',
    'UIA_LegacyIAccessibleRolePropertyId',
    'ExpandCollapseState_Collapsed', 'UIA_NavigationLandmarkTypeId',
    'UIA_TabControlTypeId', 'UIA_OverlineColorAttributeId',
    'UIA_AppBarControlTypeId', 'AnnotationType_AdvancedProofingIssue',
    'UIA_SelectionCanSelectMultiplePropertyId',
    'UIA_LocalizedControlTypePropertyId',
    'UIA_IsContentElementPropertyId', 'TreeScope_Parent',
    'HeadingLevel6', 'UIA_ScrollVerticalViewSizePropertyId',
    'TextUnit_Format', 'ProviderOptions_OverrideProvider',
    'UIA_SystemAlertEventId', 'UIA_GridPatternId',
    ...
    'UIA_NotificationEventId', 'IUIAutomationElement7',
    'UIA_RuntimeIdPropertyId',
    'UIA_SelectionIsSelectionRequiredPropertyId',
    'UIA_ClassNamePropertyId', 'UIA_IndentationTrailingAttributeId',
    'UIA_IsTextPattern2AvailablePropertyId', 'UIA_CulturePropertyId',
    'IUIAutomation6', 'UIA_IsItemContainerPatternAvailablePropertyId',
    'UIA_ImageControlTypeId',
    'UIA_IsSelectionPatternAvailablePropertyId',
    'UIA_TableColumnHeadersPropertyId', 'IUIAutomationElement5',
    'ZoomUnit', 'UIA_LegacyIAccessibleChildIdPropertyId',
    'ProviderOptions_ClientSideProvider', 'IUIAutomationTextRange2',
    'UIA_IsItalicAttributeId', 'UIA_LegacyIAccessibleHelpPropertyId',
    'UIA_MenuBarControlTypeId', 'UIA_Drag_DragCompleteEventId',
    'UIA_StructureChangedEventId', 'UIA_VisualEffectsPropertyId',
    'ExpandCollapseState_PartiallyExpanded', 'UIA_MenuClosedEventId',
    'UIA_StylesStyleIdPropertyId', 'ExpandCollapseState_LeafNode',
    'ScrollAmount_SmallIncrement', 'TextEditChangeType_None',
    ...
    'AnnotationType_Header', 'StyleId_BulletedList',
    'UIA_FormLandmarkTypeId', 'UIA_AnnotationAuthorPropertyId',
    'UIA_InvokePatternId',
    'UIA_IsTransformPatternAvailablePropertyId',
    'UIA_IsDialogPropertyId', 'UIA_ExpandCollapsePatternId',
    'UIA_DropTarget_DroppedEventId',
    'WindowInteractionState_BlockedByModalWindow',
    'UIA_HeadingLevelPropertyId', 'StructureChangeType_ChildRemoved',
    'PropertyConditionFlags_MatchSubstring', 'PropertyConditionFlags',
    'UIA_AnimationStyleAttributeId',
    'UIA_NativeWindowHandlePropertyId', 'UIA_IsPeripheralPropertyId',
    'UIA_IsGridItemPatternAvailablePropertyId', 'StyleId_Heading5',
    'IUIAutomationCondition', 'UIA_IsControlElementPropertyId',
    'UIA_LevelPropertyId', 'WindowInteractionState_Running',
    'UIA_MenuOpenedEventId', 'UIA_Window_WindowClosedEventId',
    'UIA_SeparatorControlTypeId', 'IUIAutomationElement8',
    'UIA_DescribedByPropertyId', 'UIA_StylesShapePropertyId',
    'UIA_IsEnabledPropertyId',
    'UIA_IsDropTargetPatternAvailablePropertyId',
    'IUIAutomationValuePattern', 'UIA_BackgroundColorAttributeId',
    'ZoomUnit_LargeDecrement', 'UIA_DocumentControlTypeId',
    'UIA_IsSpreadsheetPatternAvailablePropertyId',
    'UIA_MenuModeEndEventId', 'UIA_AriaPropertiesPropertyId',
    'IRawElementProviderSimple', 'ScrollAmount_SmallDecrement',
    'UIA_Text_TextChangedEventId', 'UIA_SummaryChangeId',
    ...
    'UIA_ObjectModelPatternId', 'Off',
    'AnnotationType_DeletionChange',
    'UIA_WindowCanMinimizePropertyId', 'AutomationElementMode',
    'UIA_IsSelectionPattern2AvailablePropertyId',
    'ConnectionRecoveryBehaviorOptions_Disabled',
    'IUIAutomationSelectionPattern2', 'UIA_PositionInSetPropertyId',
    'UIA_PaneControlTypeId', 'WindowVisualState_Maximized',
    'UIA_SelectionItemPatternId', 'TextEditChangeType_AutoComplete',
    'ProviderOptions_ProviderOwnsSetFocus',
    'UIA_ValueValuePropertyId', 'StyleId_Quote',
    'UIA_InputReachedOtherElementEventId',
    'IUIAutomationTogglePattern', 'AnnotationType_FormatChange',
    'SynchronizedInputType_KeyDown',
    'UIA_IsCustomNavigationPatternAvailablePropertyId',
    'UIA_HyperlinkControlTypeId', 'CoalesceEventsOptions_Disabled',
    'UIA_Transform2CanZoomPropertyId', 'UIA_ChangesEventId',
    'IUIAutomationExpandCollapsePattern',
    'UIA_Drag_DragCancelEventId', 'IUIAutomationGridPattern',
    'UIA_TableRowOrColumnMajorPropertyId', 'CUIAutomation',
    'ProviderOptions_RefuseNonClientSupport',
    'UIA_IsGridPatternAvailablePropertyId',
    'UIA_LegacyIAccessibleNamePropertyId',
    'AnnotationType_Highlighted', 'TextUnit_Character',
    'StyleId_Heading1', 'HeadingLevel3',
    'UIA_GridItemRowSpanPropertyId',
    'IUIAutomationStructureChangedEventHandler',
    'IUIAutomationDockPattern', 'SupportedTextSelection',
    'UIA_SpinnerControlTypeId', 'UIA_AutomationFocusChangedEventId',
    'UIA_TableItemRowHeaderItemsPropertyId', 'TextUnit_Document',
    'UIA_VirtualizedItemPatternId',
    'UIA_RangeValueSmallChangePropertyId', 'SynchronizedInputType',
    'SynchronizedInputType_LeftMouseUp',
    'UIA_Transform2ZoomMaximumPropertyId', 'UIA_TransformPattern2Id',
    'IUIAutomationElement2', 'UIA_SearchLandmarkTypeId',
    ...
    'UIA_TransformPatternId', 'UIA_ToggleToggleStatePropertyId',
    'UIA_MultipleViewPatternId', 'AnnotationType_Unknown',
    'NotificationProcessing_MostRecent',
    'UIA_Selection2ItemCountPropertyId', 'UIA_CustomControlTypeId',
    'UIA_MarginBottomAttributeId', 'UIA_TableControlTypeId',
    'NotificationKind_ActionAborted',
    'IUIAutomationProxyFactoryEntry', 'DockPosition_Top',
    'TextPatternRangeEndpoint', 'IUIAutomation',
    'UIA_LandmarkTypePropertyId',
    'UIA_GridItemContainingGridPropertyId',
    'ToggleState_Indeterminate', 'UIA_GridItemColumnPropertyId',
    'TextEditChangeType', 'UIA_ListItemControlTypeId',
    'UIA_IsScrollPatternAvailablePropertyId',
    'IUIAutomationPropertyCondition',
    'IUIAutomationAnnotationPattern',
    'UIA_IsScrollItemPatternAvailablePropertyId',
    'IUIAutomationElement4', 'IUIAutomationElement6',
    'UIA_LegacyIAccessibleValuePropertyId',
    'UIA_TabItemControlTypeId', 'UIA_AsyncContentLoadedEventId',
    'UIA_StylesFillColorPropertyId',
    'UIA_AnnotationDateTimePropertyId', 'TextUnit',
    'UIA_FlowsFromPropertyId', 'UIA_AnnotationObjectsPropertyId',
    'ExpandCollapseState_Expanded', 'IUIAutomation2',
    'TextUnit_Paragraph', 'UIA_ToolBarControlTypeId',
    'UIA_LinkAttributeId', 'UIA_FillTypePropertyId',
    'UIA_SpreadsheetItemAnnotationObjectsPropertyId', 'HeadingLevel2',
    'NavigateDirection_LastChild', 'StructureChangeType_ChildAdded',
    'UIA_CaretPositionAttributeId', 'AnnotationType_InsertionChange',
    'IUIAutomationTextChildPattern',
    'IUIAutomationActiveTextPositionChangedEventHandler',
    'NotificationKind_ItemAdded', 'NotificationKind_Other',
    'IUIAutomationCustomNavigationPattern', 'HeadingLevel5',
    'UIA_LegacyIAccessiblePatternId', 'UIA_LabeledByPropertyId',
    'UIA_IsSuperscriptAttributeId', 'UIA_ToolTipControlTypeId',
    'UIA_WindowCanMaximizePropertyId', 'StyleId_Subtitle',
    'SynchronizedInputType_RightMouseUp', 'UIA_DataGridControlTypeId',
    'NotificationProcessing', 'StyleId_Normal',
    'UIA_IsOffscreenPropertyId', 'UIA_SplitButtonControlTypeId',
    'IUIAutomationDropTargetPattern', 'HeadingLevel7',
    'UIA_TogglePatternId', 'UIA_TableItemPatternId', 'IUIAutomation4',
    'UIA_ActiveTextPositionChangedEventId', 'UIA_RotationPropertyId',
    'AnnotationType_Comment', 'UIA_DropTarget_DragEnterEventId',
    'UiaChangeInfo', 'HeadingLevel4', 'UIA_GridColumnCountPropertyId',
    'UIA_SynchronizedInputPatternId', 'AnnotationType_GrammarError',
    'ProviderOptions', 'UIA_AnnotationTypesAttributeId',
    'UIA_MarginTrailingAttributeId', 'UIA_ControllerForPropertyId',
    'UIA_IndentationLeadingAttributeId', 'IUIAutomationBoolCondition',
    'UIA_ForegroundColorAttributeId',
    'IUIAutomationScrollItemPattern', 'ToggleState_On',
    'IUIAutomationTransformPattern2', 'StyleId_Heading2',
    'UIA_ListControlTypeId',
    'UIA_SelectionItem_ElementAddedToSelectionEventId',
    'UIA_OutlineThicknessPropertyId', 'UIA_TreeItemControlTypeId',
    'UIA_GridRowCountPropertyId',
    'WindowInteractionState_NotResponding', 'UIA_ProcessIdPropertyId',
    'NavigateDirection', 'UIA_CheckBoxControlTypeId',
    'IUIAutomationScrollPattern', 'ExtendedProperty',
    'UIA_DropTargetDropTargetEffectsPropertyId',
    'UIA_ScrollPatternId',
    'UIA_Selection2FirstSelectedItemPropertyId',
    'UIA_FlowsToPropertyId', 'UIA_Transform2ZoomLevelPropertyId',
    'IUIAutomationLegacyIAccessiblePattern',
    'UIA_ScrollItemPatternId', 'UIA_ValueIsReadOnlyPropertyId',
    'AnnotationType_TrackChanges', 'UIA_CenterPointPropertyId',
    'TreeScope_Subtree', 'IUIAutomationInvokePattern',
    'UIA_SelectionPatternId', 'UIA_IsDragPatternAvailablePropertyId',
    'AutomationElementMode_None',
    'UIA_SelectionItem_ElementSelectedEventId',
    'UIA_FullDescriptionPropertyId', 'SupportedTextSelection_Single',
    'ZoomUnit_SmallIncrement', 'AnnotationType_DataValidationError',
    'StructureChangeType_ChildrenBulkAdded',
    'IUIAutomationTextRangeArray',
    'UIA_IsTablePatternAvailablePropertyId', 'TextUnit_Line',
    'UIA_AfterParagraphSpacingAttributeId',
    'IUIAutomationObjectModelPattern',
    'UIA_ProviderDescriptionPropertyId', 'UIA_HelpTextPropertyId',
    'StyleId_Heading4', 'UIA_ScrollVerticallyScrollablePropertyId',
    'UIA_TransformCanRotatePropertyId'
]

_check_version('1.1.14', 1662606382.006810)
